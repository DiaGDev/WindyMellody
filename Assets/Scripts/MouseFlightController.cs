...
namespace MFlight
{
    ...
    public class MouseFlightController : MonoBehaviour
    {
        ...
        private float speedMax = 1000f;
        public bool recordState = false;
        ...
        private void RotateRig()
        {
            ...
            {
                if ((speedCount * 100) < speedMax)
                {
                    speedCount++;
                    Debug.Log("Increasing Speed" + speedCount);
                }
                else
                {
                    Debug.Log("Maximal speed limit reached");
                }
            ...
            {
                if ((speedCount * 100) > speedMin)
                {
                    speedCount--;
                    Debug.Log("Reducing Speed"+speedCount);
                }
                else
                {
                    Debug.Log("Minimal speed limit reached");
                }
            ...
            if (Input.GetMouseButtonDown(2))
            {
                if (recordState==false)
                {
                    ...
                    Debug.Log("Recording" + recordState);
                    
                }
                if (recordState == true)
                {
                    recordState = false;
                    Debug.Log("Stop Recording" + recordState);
                }
