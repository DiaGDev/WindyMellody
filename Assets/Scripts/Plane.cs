...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        [Header("Physics")]
        [Tooltip("Force to push plane forwards with")] public float thrust = 200f;
        [Tooltip("Pitch, Yaw, Roll")] public Vector3 turnTorque = new Vector3(92f, 25f, 45f);
        ...
        MouseFlightController mfc;

        private void Awake()
        {
            rigid = GetComponent<Rigidbody>();
            GameObject MFR = GameObject.Find("MouseFlightRig");
            mfc = MFR.GetComponent<MouseFlightController>();
            if (controller == null)
        ...
        private void FixedUpdate()
        {
            ...
            rigid.AddRelativeForce(Vector3.forward * thrust* mfc.speedCount * forceMult, ForceMode.Force);
